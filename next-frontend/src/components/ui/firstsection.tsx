...
import { MapPin, Thermometer, Cloud, CloudDownload } from "lucide-react";
    ...
    <div className="flex p-8 w-full justify-center">
      <div className="flex space-x-4">
        ...
        <Card className="p-4 w-[400px] bg-purple-300 border-purple-900 border-4">
          <CardHeader>
            <CardTitle className="flex text-3xl font-extrabold items-center">
              <div className="text-purple-900">Weather</div>
        ...
        <Card className="p-4 w-[400px] bg-purple-300 border-purple-900 border-4">
          <CardHeader>
            <CardTitle className="flex text-3xl font-extrabold items-center">
              <div className="text-purple-900">Temperature</div>
